module object_programming::object_basic {
...
#[test_only]
module object_programming::color_objectTests {
    use sui::test_scenario;
    use object_programming::object_basic::{Self, ColorObject};
    use sui::object;
    use sui::transfer;
    use sui::tx_context;
    ...
    fun test_create() {
        ...
        let scenario = &mut scenario_val;
        {
            ...
            object_basic::create(255, 0, 255, ctx);
        };
        ...
        test_scenario::next_tx(scenario, owner);
        {
            ...
            let (red, green, blue) = object_basic::get_color(&object);
    ...
    fun test_copy_into() {
        ...
        let (id1, id2) = {
            let ctx = test_scenario::ctx(scenario);
            object_basic::create(255, 255, 255, ctx);
            let id1 =
                object::id_from_address(tx_context::last_created_object_id(ctx));
            object_basic::create(0, 0, 0, ctx);
            let id2 =
                object::id_from_address(tx_context::last_created_object_id(ctx));
            (id1, id2)
        };
        test_scenario::next_tx(scenario, owner);
        {
            ...
            let (red, green, blue) = object_basic::get_color(&obj1);
            assert!(red == 255 && green == 255 && blue == 255, 0);

            object_basic::copy_into(&obj2, &mut obj1);
